...
public class RestaurantListUserRatingAdapter extends RecyclerView.Adapter<RestaurantWithRatingViewHolder> {
        ...
        public RestaurantListUserRatingAdapter(List<Restaurant> restaurantList, User user){
            this.user=user;
